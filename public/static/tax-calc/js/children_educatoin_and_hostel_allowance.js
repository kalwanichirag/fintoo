...
const resetTab1 = () => {
    document.getElementById("month_received_child1_1").value = "",
        document.getElementById("month_received_child2_1").value = "",
        document.getElementById("allowance_received_child1_1").value = "",
        document.getElementById("allowance_received_child2_1").value = "",
        document.getElementById("exempted_allowance_child1_1").value = "";
    document.getElementById("exempted_allowance_child12_1").value = "";
    document.getElementById("exempted_allowance_total_1").value = "";
    document.getElementById("taxable_allowance_child1_1").value = "";
    document.getElementById("taxable_allowance_child2_1").value = "";
    document.getElementById("taxable_allowance_total_1").value = "";
}
const resetTab2 = () => {
    document.getElementById("month_received_child1_2").value = "",
        document.getElementById("month_received_child2_2").value = "",
        document.getElementById("allowance_received_child1_2").value = "",
        document.getElementById("allowance_received_child2_2").value = "",
        document.getElementById("exempted_allowance_child1_2").value = "";
    document.getElementById("exempted_allowance_child12_2").value = "";
    document.getElementById("exempted_allowance_total_2").value = "";
    document.getElementById("taxable_allowance_child1_2").value = "";
    document.getElementById("taxable_allowance_child2_2").value = "";
    document.getElementById("taxable_allowance_total_2").value = "";
}
// ---------------------------------------------------------input validations-------------------------------------------------
...
function ValidateMonthNumber(t) {
    const formattedVal = isNaN(t.value) ? 0 : Math.ceil(t.value)

    if (t.value !== "") {
        if (!(formattedVal > 0 && formattedVal < 13)) {
            $(t).next(".required-msg").hide()
            t.value = ""
            showAlert(); LogoShiftDown();
            return document.getElementById("income_and_tax_calculator_alert_text").innerHTML = "<strong>Error ! !</strong>  " + 'Month Should be in ranges of 1 to 12';
        } else {
            hideAlert(); LogoShiftUp();
            $(t).next(".required-msg").hide()
            return t.value = formattedVal
        }
    }
    else {
        checkInputValidity(t)
    }
}
