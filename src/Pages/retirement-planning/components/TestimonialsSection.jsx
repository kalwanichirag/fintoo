...
export default function TestimonialsSection() {
  ...
  },
  {
    ...
    link: "https://www.google.com/search?q=fintoo&rlz=1C5CHFA_enIN857IN858&oq=fintoo+&aqs=chrome.0.69i59j46i175i199i512j69i60l3j69i65j69i61l2.4396j1j7&sourceid=chrome&ie=UTF-8#lrd=0x3be7b723032fffff:0x91a61c8dda6c86c3,1,,,",
    image:
      "https://lh3.googleusercontent.com/a-/ACB-R5QjkST2h8iF4EsRxEo2XRK1ULyLvJY3aOVamfw0M94=s40-c-c0x00000000-cc-rp-mo-br100",
    review:
  ...
  return (
    <section className="tw-bg-slate-50 tw-px-[8%] tw-pb-[80px] max-md:tw-px-[5%] max-md:tw-pb-[50px]">
      
      <MotionReveal>
        <SectionHeader
          tag="Testimonials"
          title="What Our Clients Say"
          subtitle="Real experiences from clients who trusted Fintoo for their financial planning journey."
        />
      </MotionReveal>
          ...
          {reviews.map((item, index) => {
            ...
            return (
              <div key={index} className="tw-px-2">
                <MotionReveal delay={index * 30} y={14} scale={0.995} duration={460}>
                  <a
                    href={item.link}
                    target="_blank"
                  ...
                  >
                    <div className="tw-h-full tw-rounded-[14px] tw-border tw-border-slate-200 tw-bg-white tw-p-[22px] hover:tw-shadow-md tw-transition">
                      
                      {/* Stars */}
                      <div className="tw-mb-[10px] tw-text-sm tw-text-fintoo-orange">★★★★★</div>

                      {/* Review */}
                      <p className="tw-mb-[14px] tw-text-sm tw-leading-[1.65] tw-text-slate-800 tw-italic tw-line-clamp-4">
                        {item.review}
                      </p>
                      ...
                      <div className="tw-flex tw-items-center tw-gap-[10px]">
                        ...
                        {item.image ? (
                          ...
                          <div className="tw-flex tw-h-9 tw-w-9 tw-items-center tw-justify-center tw-rounded-full tw-bg-fintoo-blue tw-text-sm tw-font-semibold tw-text-white">
                            {initials}
                          </div>
                        )}

                        <div>
                          <div className="tw-text-sm tw-font-semibold tw-text-fintoo-blue">
                            {item.name}
                          </div>
