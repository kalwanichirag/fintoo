    ...
    <section className={`${styles.CalendlySection}`}>
      ...
      <div className={`${styles.CalendlySectionCalendly}`}>
        <div className={`${styles.CalendlyVerificationSection}`}>
          {tagval ? (
            <>
              <VerificationSection eventCode={tagval} serviceName="financial_planning" eventUrl={eventURL} planId="29" extraParams={extraParams} addIncomSlabAndComment={true} />
            </>
          ) : (
            <VerificationSection eventCode={'undefined_calendly'} serviceName="financial_planning" eventUrl={eventURL} planId="29" extraParams={extraParams} addIncomSlabAndComment={true} />
          )
          }
        </div>
      </div>
