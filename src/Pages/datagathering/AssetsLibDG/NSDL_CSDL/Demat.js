...
const Demat = (props) => {
    ...
    return (
        <div>
            ...
            <div className={`${Styles.linkNowbtn} ButtonBx`} style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '1rem' }}>
                {(
                    (pageurl === "/commondashboard" || pageurl === "/commondashboard/") &&
                    hideDematTab
                ) && (
                        <button
                            style={{ marginTop: "0", margin: "0.7rem" }}
