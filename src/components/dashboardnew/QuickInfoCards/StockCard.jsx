...
import { FaChartLine, FaRedo, FaDownload, FaRobot, FaCrown, FaEllipsisV } from "react-icons/fa";
    ...
    <>
      ...
      <StateBlock state={displayState} show="filled">
        <div
          ...
          className="glass-card tw-rounded-2xl tw-p-6 tw-relative tw-grid tw-items-stretch"
        >
          <div>
            <div className="tw-flex tw-items-center tw-justify-between tw-mb-6">
              <div className="tw-flex tw-items-center tw-space-x-3">
                <div className="tw-w-12 tw-h-12 tw-bg-fintoo-blue tw-rounded-xl tw-flex tw-items-center tw-justify-center">
                  <FaChartLine className="tw-text-white tw-text-2xl" />
                </div>
                <div>
    ...
    <div className="tw-grid tw-grid-cols-2 tw-gap-4 tw-text-sm">
            <div>
              ...
              <p className="tw-font-semibold">
                {stockSummary.investedValue.toLocaleString("en-IN") || 0}
              </p>
            </div>
            ...
            <div className="tw-text-right">
              ...
              <p
                className={`tw-font-semibold ${stockSummary?.totalreturn < 0 ? "!tw-text-red-600" : "!tw-text-green-600"}`}
              >
      ...
      {/* MODAL */}
      <Nsdlcsdl hideParIntro={false} ref={nsdlRef} hideDematTab={false} fromStockCard={true} />
    </>
  );
}
