...
export default function CTAFormB() {
            ...
            <div className="tw-text-center tw-mb-8">
              ...
              <p className="tw-text-gray-600">
                Start your wealth transformation journey today
                            ...
                            <LandingPageCalendly pageName="Investment Planning B" servicename={"assisted_advisory_fixed_fees"} calendlyurl={"https://calendly.com/d/cx7d-vh5-zvy/15-mins-consultation-call-with-financial-advisor?hide_event_type_details=1"} variant="minimal"/>
